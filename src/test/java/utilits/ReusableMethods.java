...
public class ReusableMethods {
    public static utilits.ReusableMethods ReusableMethods;
...
//   waitFor(5);  => waits for 5 second
    ...
    public static void tumSayfaScreenshot(WebDriver driver)  {
        ...
        // dosya yolu "target/tumSayfaSs20230227134813"
...
//    Driver.selectByIndex(dropdown element, "91303")
    ...
    public static  void signInTrendyolMethod(){
        Actions actions=new Actions(Driver.getDriver());
        TrendyolPage trendyol=new TrendyolPage();
        actions.clickAndHold(trendyol.loginButton).perform();
        ReusableMethods.wait(1);
        actions.click(trendyol.signInButton).perform();
        utilits.ReusableMethods.wait(1);
        actions.sendKeys(trendyol.emailLabelSign, "yusuf-9207@outlook.com").
                sendKeys(Keys.TAB).sendKeys("Yk123456").sendKeys(Keys.TAB, Keys.ENTER).
                perform();
